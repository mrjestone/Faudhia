...
Replace the `public/Faudhia.jpeg` file with your own avatar image. It is used on the homepage and about pages as well as on the dynamically generated `open-graph` images.
